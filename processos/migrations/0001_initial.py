# Generated by Django 2.1.7 on 2020-03-29 00:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantCompra', models.IntegerField(blank=True, null=True, verbose_name='quantCompra')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantCompra', models.IntegerField(blank=True, null=True, verbose_name='quantCompra')),
                ('quantLote', models.IntegerField(blank=True, null=True, verbose_name='quantLote')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='estoque',
            name='lote',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lote', to='processos.Lote'),
        ),
        migrations.AddField(
            model_name='estoque',
            name='produto',
